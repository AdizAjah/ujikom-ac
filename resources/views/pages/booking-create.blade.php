            ...
            <div class="p-6 md:p-10 text-gray-900 dark:text-gray-100">
                ...
                <form action="{{ route('booking.store') }}" method="POST">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Pilih hanya tanggal kedatangan teknisi.</p>
                    </div>

                    <div>
                        <label for="booking_time" class="block font-medium text-sm text-gray-700 dark:text-gray-300">
                            Jam Booking
                        </label>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Pilih hanya waktu kedatangan teknisi.</p>
                    </div>
                    

                    <!-- No. Telepon -->
                    <div class="mt-4">
                        <label for="user_phone" class="block font-medium text-sm text-gray-700 dark:text-gray-300">
                        ...
                        <input id="user_phone"
                               ...
                               required />
                        <p class="text-sm text-gray-500 mt-1">Format wajib: 628xxxxxxxxxx (tidak boleh 08…)</p>
                    </div>

                    <!-- Alamat -->
                    <div class="mt-4">
                        <label for="user_address" class="block font-medium text-sm text-gray-700 dark:text-gray-300">
                        ...
                        <textarea id="user_address" name="user_address" rows="4"
                                  class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 
                                         dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 
                                         focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                                  required>{{ old('user_address', Auth::user()->address) }}</textarea>
                    </div>
                    ...
                    <div class="flex items-center justify-end mt-6">
                        <button type="submit"
                            class="w-full text-center inline-block bg-blue-600 text-white font-bold py-3 px-6 
