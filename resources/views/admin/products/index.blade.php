                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <img src="{{ Storage::url($product->image_url) }}" alt="{{ $product->name }}" class="w-16 h-16 object-cover rounded">
                                    </td>
                                ...
                                @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-4 whitespace-nowrap text-sm text-center">No products found.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
